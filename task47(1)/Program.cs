// Дoмашняя работа. Задача 47. Задайте двумерный массив размером m×n, заполненный случайными вещественными числами.
...
double[,] matrixArray = GreatMatrixRndDouble(4, 9, 1.2, 1.07);
